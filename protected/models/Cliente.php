...
class Cliente extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cedula, nombre, apellido, telefono', 'required'),
			array('estado', 'numerical', 'integerOnly'=>true),
			array('cedula', 'length','min'=>7, 'max'=>12),
			array('nombre, apellido, telefono, rif', 'length', 'max'=>45),
			array('cedula','unique', 'message'=>'Ya se encuentra registrado el numero cedula'),
			array('rif','unique', 'message'=>'Ya se encuentra registrado el numero RIF'),
	...
	public function relations()
	{
		...
		return array(
			'facturas' => array(self::HAS_MANY, 'Factura', 'clientes_id'),
			'pedidos' => array(self::HAS_MANY, 'Pedido', 'clientes_id'),
		);
	}
